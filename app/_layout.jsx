...
import { Slot, Stack } from "expo-router"; // Slot и Stack  — ключевые компоненты в Expo Router, которые используются для создания гибких и структурированных пользовательских интерфейсов
